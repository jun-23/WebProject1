...
public class TierReviewDomain {
	...
	public String toString() {
		return "TierReviewDomain [tierReviewId=" + tierReviewId + ", user=" + user + ", tierReview=" + tierReview
				+ ", tier=" + tier + "]";
	}

	public int getTierReviewId() {
		return tierReviewId;
	}

	public void setTierReviewId(int tierReviewId) {
		this.tierReviewId = tierReviewId;
	}
	...
	public String getTierReview() {
		return tierReview;
	}

	public void setTierReview(String tierReview) {
		this.tierReview = tierReview;
	}
