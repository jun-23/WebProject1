...
import Home from "@/components/iamport/Home.vue";
import payment from "@/components/iamport/Payment.vue";
import certification from "@/components/iamport/Certification.vue";
import result from "@/components/iamport/Result.vue";
...
const router = createRouter({
  ...
  routes: [
    ...
    {
      path: "/iamportcertification",
      name: "iamportcertification",
