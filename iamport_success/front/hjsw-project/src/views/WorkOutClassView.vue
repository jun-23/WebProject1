  ...
  <main>
    ...
    <div class="carousel-container">
      <div class="navigation-buttons">
        ...
        &emsp;&emsp;&emsp;&emsp;
        <span>{{ label1}}</span>&emsp;&emsp;&emsp;&emsp;
      ...
      >
        <div
          class="panel"
          v-for="(image, index) in DefaultimagesPlatinum"
          :key="index"
        >
          <router-link
            :to="{
    ...
    <div class="carousel-container">
      <div class="navigation-buttons">
        ...
        &emsp;&emsp;&emsp;&emsp;
        <span>{{ label2}}</span>&emsp;&emsp;&emsp;&emsp;
      ...
      >
        <div class="panel" v-for="(image, index) in DefaultimagesGold" :key="index">
          <router-link
            :to="{
              name: 'videoList',
    ...
    <div class="carousel-container">
      <div class="navigation-buttons">
        ...
        &emsp;&emsp;&emsp;&emsp;
        <span>{{ label3}}</span>&emsp;&emsp;&emsp;&emsp;
      ...
      >
        <div class="panel" v-for="(image, index) in DefaultimagesSilver" :key="index">
          <router-link
            :to="{
              name: 'videoList',
    ...
    <div class="carousel-container">
      <div class="navigation-buttons">
        ...
        &emsp;&emsp;&emsp;&emsp;
        <span>{{ label4}}</span>&emsp;&emsp;&emsp;&emsp;
      ...
      >
        <div class="panel" v-for="(image, index) in DefaultimagesBronze" :key="index">
          <router-link
            :to="{
              name: 'videoList',
...
import bj1 from "@/assets/goods/bj1.jpg";
import bj2 from "@/assets/goods/bj2.jpg";
import bj3 from "@/assets/goods/bj3.jpg";
import bj4 from "@/assets/goods/bj4.jpg";


import ch1 from "@/assets/goods/ch1.jpg";
import ch2 from "@/assets/goods/ch2.jpg";

import you1 from "@/assets/goods/you1.jpg";
import you2 from "@/assets/goods/you2.jpg";
import you3 from "@/assets/goods/you3.jpg";
import you4 from "@/assets/goods/you4.jpg";
import you5 from "@/assets/goods/you5.jpg";

// 아이돌 라인

import idol_1 from "@/assets/goods/idol_1.jpeg";
import idol_2 from "@/assets/goods/idol_2.jpeg";
import idol_3 from "@/assets/goods/idol_3.jpeg";
import idol_4 from "@/assets/goods/idol_4.jpeg";
import idol_5 from "@/assets/goods/idol_5.jpeg";
import idol_6 from "@/assets/goods/idol_6.jpeg";

//처음 페이지는 스트리머니까 Default 값을 스트리머로 해놓는다.

const DefaultimagesPlatinum = ref([
  { src: bj1 },
  { src: bj2 },
  { src: bj3 },
  { src: bj4 },
...
//각 누름값에 따라 변경될 수 있게 조정한 것들

//현재는 동일하게 운동으로만 되는데, 이를 노가다성으로 작업하면 각 버튼마다 원하는 사진들이 나오게 할 수 있음
...
const label1 = ref("아프리카");
const label2 = ref("치지직");
const label3 = ref("유튜브");
const label4 = ref("기타");
...
// Update the images based on the selected genre
switch (value) {
    case 1:
    DefaultimagesPlatinum.value = imagesPlatinum.value;
    DefaultimagesGold.value = imagesGold.value;
    DefaultimagesSilver.value = imagesSilver.value;
    DefaultimagesBronze.value = imagesBronze.value;
    label1.value = "아프리카";
    label2.value = "치지직";
    label3.value = "유튜브";
    label4.value = "기타";
      ...
      break;
    case 2:
    DefaultimagesPlatinum.value = imagesGold.value;
    DefaultimagesGold.value = imagesPlatinum.value;
    DefaultimagesSilver.value = imagesSilver.value;
    DefaultimagesBronze.value = imagesBronze.value;
    label1.value = "싱글게임";
    label2.value = "온라인게임";
    ...
    label4.value = "기타";
      ...
      break;
    case 3:
    DefaultimagesPlatinum.value = imagesSilver.value;
    DefaultimagesGold.value = imagesPlatinum.value;
    DefaultimagesSilver.value = imagesGold.value;
    DefaultimagesBronze.value = imagesBronze.value;
    label1.value = "작품별";
    label2.value = "남자배우별";
    label3.value = "여자배우별";
    label4.value = "그외";
      ...
      break;
    case 4:
    DefaultimagesPlatinum.value = imagesBronze.value;
    DefaultimagesGold.value = imagesPlatinum.value;
    DefaultimagesSilver.value = imagesGold.value;
    DefaultimagesBronze.value = imagesSilver.value;
    label1.value = "4세대";
    label2.value = "3세대";
    label3.value = "2세대";
    label4.value = "그외";
